...
const Navbar = ({ searchQuery = "", onSearchChange, showSearch = true }: NavbarProps) => {
  ...
  return <header className="sticky top-0 z-50">
    <div className="mx-auto flex h-[50px] max-w-[1080px] items-center justify-between rounded-b-xl bg-[#2b2b2b] px-5">
      ...
      {showSearch && <div className={`flex items-center transition-all duration-200 ${searchOpen ? "w-52" : "w-[200px]"}`}>
