...
export const games: Game[] = [
  ...
  { id: "20", title: "Tiletopia", description: "Place small tiles containing homes and forests to make a small island.", category: "puzzle", thumbnail_url: "https://6nilllqpgkm6o.h5games.usercontent.goog/v/7d3689i7s5gfo/MarketingAssets/tiletopia-app-icon-512x512.png", html_file: "/tiletopia.html" },
  ...
  { id: "23", title: "Plants vs. Zombies", description: "A strategical game about plants with abilities fighting zombies.", category: "strategy", thumbnail_url: "https://m.media-amazon.com/images/I/61Aethog1iL.png", html_file: "/plants-vs-zombies.html" },
  ...
  { id: "48", title: "Crazy Cattle 3D", description: "Go around tipping cows but not getting tipped yourself!", category: "action", thumbnail_url: "https://crazy-cattle.co/data/image/game/crazy-cattle/crazy-cattle.jpg", html_file: "/crazy-cattle.html" },
  { id: "49", title: "Bitlife", description: "Roleplay as sperm frfr then be grown then die fr.", category: "Strategy", thumbnail_url: "https://play-lh.googleusercontent.com/fUM-UyywXxjC8soxAZdIlxJrlRRXmql8wkE426SHzft4lJycSKVd2jCYQQX1BEG9Xw", html_file: "/bitlife.html" },
];
