...
export const games: Game[] = [
  ...
  { id: "36", title: "Little Big Planet (PSP)", description: "A 3D side-scrolling game with cute little felt characters.", category: "puzzle", thumbnail_url: "https://assets-prd.ignimgs.com/2022/01/07/littlebigplanet-1-button-crop-1641596100455.jpg", html_file: "ovo.html" },
