...
export const games: Game[] = [
  ...
  { id: "39", title: "Tag", description: "Multiplayer tag game.", category: "multiplayer", thumbnail_url: "https://img.poki-cdn.com/cdn-cgi/image/q=78,scq=50,width=314,height=314,fit=cover,f=auto/32d2ba6c9b5c4a1e8f7d9a0b1c2d3e4f.png", html_file: "/games/tag.html" },
